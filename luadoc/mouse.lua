...
-- @field protocol_screen Mouse protocol screen number.
-- @class table
-- @name mouse

--- Get or set the mouse coords.
-- @param coords_table None or a table with a protocol screen number and x and y keys as mouse coordinates.
